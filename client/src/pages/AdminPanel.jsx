    ...
    return (
        <div className="max-w-xl mx-auto space-y-8">
            <div className="flex items-center gap-3 mb-8">
                ...
                <h1 className="text-3xl font-display font-bold text-on-surface">Admin Control</h1>
            </div>

            {response && (
                <div className="p-4 bg-surface-low border-l-4 border-primary text-on-surface rounded-sm">
                    {response}
                </div>
            )}
