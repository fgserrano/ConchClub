...
export default function OfficialSelectionPage() {
    ...
    useEffect(() => {
        api.get('/season/active/selection')
            .then(res => {
                const allSelections = res.data || [];
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-700">
            ...
            {selection ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-canvas-muted-foreground bg-canvas-container border border-border">
