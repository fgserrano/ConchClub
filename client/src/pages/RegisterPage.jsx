            ...
            <div className="relative h-screen w-full md:w-auto">
                ...
                <div className="absolute inset-0 flex flex-col px-8 md:px-16">
                    <div className="pt-10 md:text-right">
                        ...
                        <p
                            className="font-display text-sm text-primary-container/60 uppercase tracking-[0.1em] mt-1"
                            style={{ textShadow: '0 0 16px rgba(0,0,0,0.55), 0 2px 4px rgba(0,0,0,0.85)' }}
                        >
                            Join the Club
                        </p>
                        ...
                        <div className="w-full max-w-xs" style={{ filter: 'drop-shadow(0 0 16px rgba(0,0,0,0.55)) drop-shadow(0 2px 4px rgba(0,0,0,0.85))' }}>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex">
                                        <div className="w-1.5 bg-accent-terracotta rounded-l-sm flex-shrink-0" />
                                        <input
                                            name="inviteCode"
                                            type="text"
                                            required
                                ...
                                >
                                    {loading
                                        ...
                                        : <><span>Join the Archive</span><ArrowRight className="w-4 h-4" /></>
                                    }
                                </button>
                            </form>
                        </div>
                    ...
                    <div className="flex gap-8 pb-10 md:justify-end">
                        <Link to="/login" className="text-surface/50 text-xs uppercase tracking-[0.08em] font-display hover:text-surface/80 transition-colors">
